package com.twa.flights.api.provider.alpha.controller.documentation;
...
@Tag(name = "Provider Alpha", description = "Operations about the pricing")
    ...
    @Operation(description = "Get flights availability", responses = {
            @ApiResponse(responseCode = "200", description = "The itineraries with the conditions of search", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = AvailabilityRequestDTO.class))) }, tags = {
                    "Provider Alpha" }, parameters = {
                            ...
                            @Parameter(in = ParameterIn.QUERY, name = "departure", description = "Every segment's departure date comma separated. (e.g. 2022-03-29,2022-04-03)", required = true, example = "2022-03-29,2022-04-03"),
